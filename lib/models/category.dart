...
List<Category> categories = [
  Category(9, "General Knowledge", categoryImage: path + 'general_knowledge.jpg'),
  ...
  Category(13, "Musicals & Theatres", categoryImage: path + 'musicals_theatres.jpg'),
  ...
  Category(31, "Japanese Anime & Manga", categoryImage: path + 'japanese_anime.jpg'),
